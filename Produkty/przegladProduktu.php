...
<html lang = "PL">
	...
	<h4>Dane dotyczace produktu:</h4> 
	<div><form method = "post" action = "">
	<?php
    echo "<label><span>Nazwa: </span>
				<input type = \"text\" name = \"Nazwa\" maxlength = \"100\" value = \"$nazwa\"  autofocus disabled/>
				</label></div>
				<br/>
				<div><label><span>Opis: </span>
				<input type = \"text\" name = \"Opis\" maxlength = \"255\" value = \"$opis\" disabled/>
				</label></div>
				<br/>
				<div><label><span>Name: </span>
				<input type = \"text\" name = \"Name\" maxlength = \"100\"  value = \"$name\" disabled/>
				</label></div>
				<br/>
				<div><label><span>Description: </span>
				<input type = \"text\" name = \"Description\" maxlength = \"255\" value = \"$description\" disabled/>
				</label></div>
				<br/>
				<div><label><span>Nombre: </span>
				<input type = \"text\" name = \"Nombre\" maxlength = \"100\"  value = \"$nombre\" disabled/>
				</label></div>
				<br/>
				<div><label><span>Descripción: </span>
				<input type = \"text\" name = \"Descripcion\" maxlength = \"255\" value = \"$descripcion\" disabled/>
				</label></div>
				<br/>
				<div><label><span>Cena: </span>
				<input type = \"number\" name = \"Cena\" step=\"0.01\" min=\"0\" value = \"$cena\" required disabled/>
				</label></div>
				<br/>
				<div><label><span>Stan Magazynowy: </span>
				<input type = \"number\" name = \"StanMagazynowy\" min=\"0\" value = \"$stan\" required disabled/>
				</label></div>"
				?>
  </form>
	</div>

...
<html lang = "PL">
	<head>
		<meta charset = "utf-8">
		<title>Tokio - stolica Japonii</title>
		...
		<script type="text/javascript" src="javascript/javascript4.js" ></script>
...
<li><a href="#temat2">Położenie</a></li>
<li><a href="#temat3">Pałac Cesarski</a></li>
<li><a href="#temat4">Akihabara</a></li>
<li><a href="#temat5">Shinjuku</a></li>
...
<br/>
<div id="temat1">&nbsp;</div>
<img src="obrazki/flaga.png" id="flaga" height="100" width="170" alt="Flaga Tokio">
<p><b>Tokio -</b> stolica Japonii położona nad Oceanem Spokojnym (Zatoka Tokijska) na Honsiu – największej z Wysp Japońskich. Główny ośrodek największego zespołu miejskiego świata (metropolis Wielkie Tokio), który, wraz z Jokohamą, Kawasaki, Saitamą i innymi miastami nad zatoką, skupia 31 – 35 mln mieszkańców.</p>
<br/>
<br/>
<br/>
<strong>Dzielnice wchodzącze w skład Tokio:</strong>
<ul>
<li>Ōtemachi</li>
<li>Ginza</li>
<li>Tsukiji</li>
...
<br/>
<table class = "center">
	<caption>Podstawowe informacje</caption>
  <tr><th>Wyspa</th><th>Region</th><th>Powierzchnia</th><th>Ludność</th></tr>
  <tr><td>Honsiu</td><td>Kanto</td><td>2187,65km<span class = "super">2</span></td><td>13 161 751</td></tr>
</table>
<br/>
<br/>
<hr/>
<div id="temat2">
<h2>Położenie</h2></div>
<IMG class="right" src="obrazki/polozenie.png"  height="200" width="150" alt="Położenie Tokio">
<p>Metropolia leży w regionie Kantō, na największej japońskiej równinie na wyspie Honsiu, u ujścia rzeki Sumida do Zatoki Tokijskiej. Współrzędne geograficzne centralnej części miasta to: 35°41' szerokości geograficznej północnej i 139°46' długości geograficznej wschodniej.
...
<br/> 
<div id="temat3">
<h2>Pałac Cesarski</h2></div>
<div id = "zmiana">
<IMG class="bottom" src="obrazki/palac.jpg" height="200" width="600" alt="Pałac Cesarski">
<IMG class="top" src="obrazki/palac2.jpg" height="200" width="600" alt="Pałac Cesarski">
</div>
<br/>
<p><u>Pałac Cesarski</u> w Tokio to główna rezydencja cesarza Japonii. Znajduje się w dzielnicy Chiyoda, bardzo blisko stacji kolejowej Tokio. Powierzchnia całego zespołu pałacowego, z kompleksami budynków o różnym przeznaczeniu, równa jest powierzchni Parku Centralnego w Nowym Jorku i wynosi 341 hektarów.</p>

<p>W wyniku restauracji Meiji i po rezygnacji Tokugawy Yoshinobu, ostatniego, piętnastego shōguna z rodu Tokugawa, stolica Japonii została przeniesiona z Kioto do Edo, które przemianowano na Tokio (Wschodnia Stolica). Dawna twierdza Tokugawów, Zamek Edo, stała się rezydencją cesarza (Pałac Cesarski w Kioto nadal istnieje). W okresie od 1888 do 1948 pałac był nazywany "pałacem-zamkiem" (jap. 宮城 Kyūjō?).</p>

<p>Zespół pałacowy uległ zniszczeniom w wyniku bombardowań w czasie II wojny światowej. Remont i modernizacja całego kompleksu została zakończona w 1968 roku, z zachowaniem japońskiego stylu architektonicznego. Główny budynek pałacowy nie został postawiony na miejscu dawnego pałacu shōguna, który znajdował się na terenie Ogrodów Wschodnich. W 1993 ukończono nową rezydencję dla obecnego cesarza Akihito.</p>

<p>Większa część terenu pałacowego jest zamknięta dla zwiedzających. Można jednak rezerwować (także przez Internet) wycieczki z przewodnikiem w Agencji Dworu Cesarskiego. Pałac Cesarski jest ogólnie dostępny tylko dwa dni w roku: w urodziny cesarza (23 grudnia) oraz z okazji Nowego Roku (2 stycznia). Rodzina cesarska ukazuje się wówczas na oszklonym tarasie.</p>

<p>Na terenie Wschodnich Ogrodów znajduje się Muzeum Zbiorów Cesarskich.</p>
<br/>
<br/>
<hr/> 
<br/> 

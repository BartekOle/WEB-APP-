<%@ Page Language="VB" AutoEventWireup="false" CodeFile="podsumowanie.aspx.vb" Inherits="Default2" %>
      ...
      <ul>
       <li><a href="pamiatki.aspx">Pamiatki</a></li>
		...
		<li><a href="mailto:dios1415@gmail.com">Kontakt</a></li>
            ...
            <p><span class ="tytul">Wybierz metode dostawy:</span><br/>
                <asp:RadioButtonList ID="dostawa" runat="server" AutoPostBack="True" >
                        <asp:ListItem Value = "poczta" Selected="True">Poczta polska - 5 zl</asp:ListItem>
                        <asp:ListItem Value = "kurier">Kurier - 15 zl</asp:ListItem>
                        <asp:ListItem Value = "paczkomat">Paczkomat - 10 zl</asp:ListItem>
                        <asp:ListItem Value = "osobisty">Odbior osobisty - 0 zl</asp:ListItem>
                    </asp:RadioButtonList>
                   </p>
          ...
          <br/>
          <asp:Button ID="potwierdz" runat="server" Text="Przejdz do potwierdzenia" Visible = "false" />
			</form>
